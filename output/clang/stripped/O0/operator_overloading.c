...

{
  ...
  local_c = 0;
  FUN_001011e0(local_14,1,2);
  FUN_001011e0(local_1c,3,4);
  local_24 = FUN_00101200(local_14,local_1c);
  poVar1 = std::operator<<((ostream *)PTR_cout_00103fc8,"Result: ");
  poVar1 = (ostream *)FUN_00101240(poVar1,&local_24);
...
void FUN_001011e0(undefined4 *param_1,undefined4 param_2,undefined4 param_3)
...
undefined8 FUN_00101200(int *param_1,int *param_2)

{
  undefined8 local_10;
  
  FUN_001011e0(&local_10,*param_1 + *param_2,param_1[1] + param_2[1]);
  return local_10;
}
...
ostream * FUN_00101240(ostream *param_1,int *param_2)
