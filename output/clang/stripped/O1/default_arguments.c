...

{
  ...
  (*(code *)PTR___libc_start_main_00103fc0)
            (FUN_001012e0,param_2,&stack0x00000008,0,0,param_1,auStack_8);
  do {
...
undefined8 FUN_001011b0(char *param_1,int param_2,char *param_3)

{
  ...
  if (param_3 == (char *)0x0) {
    ...
    std::__ostream_insert<char,std::char_traits<char>>((ostream *)PTR_cout_00103fc8,param_3,sVar3);
  }
  puVar2 = PTR_cout_00103fc8;
  std::__ostream_insert<char,std::char_traits<char>>((ostream *)PTR_cout_00103fc8," - Level ",9);
  poVar4 = (ostream *)std::ostream::operator<<((ostream *)puVar2,param_2);
  ...
  if (plVar1 == (long *)0x0) {
    ...
    FUN_001011b0("System started",1,&DAT_00102022);
    FUN_001011b0("Connection lost",3,&DAT_00102022);
    FUN_001011b0("Disk full",5,"CRITICAL");
    return 0;
  }
  if ((char)plVar1[7] == '\0') {
