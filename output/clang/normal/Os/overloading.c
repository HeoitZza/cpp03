...

{
  ...
  std::__ostream_insert<char,std::char_traits<char>>
            ((ostream *)PTR_cout_00103fc8,anon_var_dwarf_27,8);
  plVar1 = (long *)std::ostream::operator<<((ostream *)this,age);
...

{
  ...
  std::__ostream_insert<char,std::char_traits<char>>
            ((ostream *)PTR_cout_00103fc8,anon_var_dwarf_27,8);
  poVar1 = (ostream *)std::ostream::operator<<((ostream *)this,age);
  std::__ostream_insert<char,std::char_traits<char>>(poVar1,anon_var_dwarf_4a,7);
  poVar1 = std::ostream::_M_insert<double>(height);
...

{
  ...
  this = PTR_cout_00103fc8;
  std::__ostream_insert<char,std::char_traits<char>>
            ((ostream *)PTR_cout_00103fc8,anon_var_dwarf_60,0xf);
  plVar1 = (long *)std::ostream::operator<<((ostream *)this,i);
  std::ios::widen((char)*(undefined8 *)(*plVar1 + -0x18) + (char)plVar1);
  std::ostream::put((char)plVar1);
  std::ostream::flush();
  return;
...

{
  ...
  std::__ostream_insert<char,std::char_traits<char>>
            ((ostream *)PTR_cout_00103fc8,anon_var_dwarf_76,0x12);
  if (s == (char *)0x0) {
    std::ios::clear((int)puVar1 + (int)*(undefined8 *)(*(long *)puVar1 + -0x18));
  }
  else {
    sVar2 = strlen(s);
    std::__ostream_insert<char,std::char_traits<char>>((ostream *)PTR_cout_00103fc8,s,sVar2);
  }
