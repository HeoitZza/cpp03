...

{
  ...
  *param_2 = &PTR_FUN_00103da0;
  ...
  if (0xf < local_60) {
    ...
    uVar3 = std::__cxx11::string::_M_create(puVar1,(ulong)&local_60);
    *puVar1 = uVar3;
    param_2[3] = local_60;
  }
  if (uVar2 != 0) {
    if (uVar2 == 1) {
      *(undefined1 *)*puVar1 = (char)*__src_00;
    }
    else {
      memcpy((undefined1 *)*puVar1,__src_00,uVar2);
    }
  }
  param_2[2] = local_60;
...
void FUN_001013e0(long param_1)
