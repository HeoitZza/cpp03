...

{
  ...
  std::__ostream_insert<char,std::char_traits<char>>
            ((ostream *)PTR_cout_00103fc8,&DAT_0010201b,0x16);
  fputs("RAII Sample",__stream);
  FUN_001011c6(&local_18);
  return 0;
}



// ===== Function: FUN_001011c6 =====

void FUN_001011c6(undefined8 *param_1)

{
  if ((FILE *)*param_1 != (FILE *)0x0) {
    fclose((FILE *)*param_1);
    std::__ostream_insert<char,std::char_traits<char>>
              ((ostream *)PTR_cout_00103fc8,&DAT_00102032,0x1d);
    return;
  }
  return;
}
