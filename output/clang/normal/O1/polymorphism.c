...

{
  ...
  *plVar1 = (long)&PTR_speak_00103d90;
  std::__ostream_insert<char,std::char_traits<char>>
            ((ostream *)PTR_cout_00103fc8,anon_var_dwarf_2f,0x23);
  (**(code **)*plVar1)(plVar1);
...
{
  std::__ostream_insert<char,std::char_traits<char>>((ostream *)PTR_cout_00103fc8,"Woof!\n",6);
  return;
}
