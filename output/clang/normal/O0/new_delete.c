...

{
  ...
  poVar1 = (ostream *)(*(code *)PTR_operator<<_00104008)();
  return poVar1;
}
...

{
  ...
  pvVar1 = (void *)(*(code *)PTR_operator_new_00104010)();
  return pvVar1;
}
...

{
  ...
  this = (Target *)operator_new(1);
                    /* try { // try from 00101193 to 00101197 has its CatchHandler @ 001011d6 */
  Target::Target(this);
  if (this != (Target *)0x0) {
                    /* try { // try from 001011b7 to 001011bf has its CatchHandler @ 001011f0 */
    Target::~Target(this);
...
/* DWARF original prototype: void Target(Target * this) */

void __thiscall Target::Target(Target *this)
...

{
  ...
  std::operator<<((ostream *)PTR_cout_00103fc8,anon_var_dwarf_4e);
  return;
}
