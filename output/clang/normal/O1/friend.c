...

{
  ...
  poVar1 = (ostream *)std::ostream::operator<<((ostream *)os,p->x);
  std::__ostream_insert<char,std::char_traits<char>>(poVar1,", ",2);
  poVar1 = (ostream *)std::ostream::operator<<((ostream *)poVar1,p->y);
...

{
  ...
  std::__ostream_insert<char,std::char_traits<char>>
            ((ostream *)PTR_cout_00103fc8,anon_var_dwarf_6e,0xf);
  std::__ostream_insert<char,std::char_traits<char>>((ostream *)this,"(",1);
  poVar3 = (ostream *)std::ostream::operator<<((ostream *)this,10);
  std::__ostream_insert<char,std::char_traits<char>>(poVar3,", ",2);
  poVar3 = (ostream *)std::ostream::operator<<((ostream *)poVar3,0x14);
  std::__ostream_insert<char,std::char_traits<char>>(poVar3,")",1);
  plVar1 = *(long **)(this + *(long *)(*(long *)this + -0x18) + 0xf0);
  if (plVar1 == (long *)0x0) {
    iVar2 = std::__throw_bad_cast();
    return iVar2;
  }
  if ((char)plVar1[7] == '\0') {
