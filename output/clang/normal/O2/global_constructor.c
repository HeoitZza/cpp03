...

{
  std::__ostream_insert<char,std::char_traits<char>>
            ((ostream *)PTR_cout_00103fc8,anon_var_dwarf_89,0x2d);
...

{
  ...
  std::__ostream_insert<char,std::char_traits<char>>
            ((ostream *)PTR_cout_00103fc8,anon_var_dwarf_5c,0x1c);
  std::__ostream_insert<char,std::char_traits<char>>((ostream *)puVar1,anon_var_dwarf_7f,0x1c);
  return 0;
}
...
{
  std::__ostream_insert<char,std::char_traits<char>>
            ((ostream *)PTR_cout_00103fc8,anon_var_dwarf_9f,0x2a);
  return;
}
