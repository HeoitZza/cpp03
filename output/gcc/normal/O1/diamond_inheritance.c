...

{
  ...
  std::__ostream_insert<char,std::char_traits<char>>((ostream *)&std::cout,"Animal eats",0xb);
...
LAB_001012ba:
  ...
  else if ((char)plVar1[7] == '\0') goto LAB_001012ba;
  std::ostream::put('@');
  std::ostream::flush();
  ...
  else if ((char)plVar1[7] != '\0') goto LAB_00101295;
  std::ctype<char>::_M_widen_init();
  (**(code **)(*plVar1 + 0x30))(plVar1,10);
LAB_00101295:
