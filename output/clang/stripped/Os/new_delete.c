...

{
  ...
  (*(code *)PTR___libc_start_main_00103fc0)
            (FUN_0010113c,param_2,&stack0x00000008,0,0,param_1,auStack_8);
  do {
...

{
  ...
  std::__ostream_insert<char,std::char_traits<char>>
            ((ostream *)PTR_cout_00103fc8,&DAT_00102004,0x11);
  std::__ostream_insert<char,std::char_traits<char>>((ostream *)puVar1,&DAT_00102016,0x11);
  return 0;
}
