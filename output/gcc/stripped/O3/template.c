...

{
  ...
  poVar3 = (ostream *)std::ostream::operator<<((ostream *)std::cout,0x14);
  std::__ostream_insert<char,std::char_traits<char>>(poVar3," ",1);
  poVar3 = std::ostream::_M_insert<double>(DAT_00102008);
  ...
  if (plVar1 == (long *)0x0) {
    ...
    (*(code *)PTR___libc_start_main_00103fe0)
              (FUN_00101120,uVar2,&stack0xfffffffffffffff0,0,0,auVar4._8_8_,&uStack_18);
    do {
