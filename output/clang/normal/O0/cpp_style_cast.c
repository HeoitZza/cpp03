...

{
  ...
  if (this == (Derived *)0x0) {
    ...
    local_58 = __dynamic_cast(this,&Base::typeinfo,&Derived::typeinfo,0);
  }
  if (local_58 != 0) {
    this_00 = std::operator<<((ostream *)PTR_cout_00103fc8,"Downcast success!");
    std::ostream::operator<<
              (this_00,(_func_ostream_ptr_ostream_ptr *)
                       PTR_endl<char,std_char_traits<char>>_00103fb8);
  }
  if (this != (Derived *)0x0) {
    (*(this->super_Base)._vptr_Base[1])();
  }
  return 0;
}
...

{
  ...
  (this->super_Base)._vptr_Base = (_func_int **)&PTR__Derived_00103d70;
  return;
}
...

{
  ...
  this->_vptr_Base = (_func_int **)&PTR__Base_00103d90;
  return;
}
