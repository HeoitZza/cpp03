...

{
  ...
  std::__ostream_insert<char,std::char_traits<char>>
            ((ostream *)PTR_cout_00103fc8,anon_var_dwarf_2b,8);
  plVar2 = (long *)std::ostream::operator<<((ostream *)this,age);
...

{
  ...
  std::__ostream_insert<char,std::char_traits<char>>
            ((ostream *)PTR_cout_00103fc8,anon_var_dwarf_2b,8);
  poVar2 = (ostream *)std::ostream::operator<<((ostream *)this,age);
  std::__ostream_insert<char,std::char_traits<char>>(poVar2,anon_var_dwarf_4e,7);
  poVar2 = std::ostream::_M_insert<double>(height);
...

{
  ...
  this = PTR_cout_00103fc8;
  std::__ostream_insert<char,std::char_traits<char>>
            ((ostream *)PTR_cout_00103fc8,anon_var_dwarf_64,0xf);
  plVar2 = (long *)std::ostream::operator<<((ostream *)this,i);
  plVar1 = *(long **)((long)plVar2 + *(long *)(*plVar2 + -0x18) + 0xf0);
  if (plVar1 == (long *)0x0) {
                    /* WARNING: Subroutine does not return */
    std::__throw_bad_cast();
...

{
  ...
  std::__ostream_insert<char,std::char_traits<char>>
            ((ostream *)PTR_cout_00103fc8,anon_var_dwarf_7a,0x12);
  if (s == (char *)0x0) {
    std::ios::clear((int)puVar2 + (int)*(undefined8 *)(*(long *)puVar2 + -0x18));
  }
  else {
    sVar3 = strlen(s);
    std::__ostream_insert<char,std::char_traits<char>>((ostream *)PTR_cout_00103fc8,s,sVar3);
  }
