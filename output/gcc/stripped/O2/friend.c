...

{
  ...
  local_28 = DAT_00102020;
  poVar3 = std::operator<<((ostream *)std::cout,&DAT_0010200b);
  plVar4 = (long *)FUN_00101310(poVar3,&local_28);
  ...
  if (plVar1 == (long *)0x0) {
    if (local_20[0] == *(long *)(in_FS_OFFSET + 0x28)) {
      ...
      (*(code *)PTR___libc_start_main_00103fe0)
                (FUN_00101140,uVar2,local_20,0,0,auVar5._8_8_,&local_28);
      do {
...
ostream * FUN_00101310(ostream *param_1,int *param_2)
