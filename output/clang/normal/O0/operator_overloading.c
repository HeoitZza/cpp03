...
/* DWARF original prototype: void Point(Point * this, int x, int y) */

void __thiscall Point::Point(Point *this,int x,int y)
...

{
  ...
  Point((Point *)&this_local,this->x + other->x,this->y + other->y);
...
/* WARNING: Variable defined which should be unmapped: os_local */
