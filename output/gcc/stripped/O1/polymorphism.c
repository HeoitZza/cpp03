...

{
  ...
  *plVar2 = (long)&PTR_FUN_00103d58;
  __s1 = *(char **)(PTR_PTR_00103d50 + 8);
  if (__s1 != "3Dog") {
    if (*__s1 == '*') goto LAB_0010120d;
    iVar1 = strcmp(__s1,"3Dog");
    if (iVar1 != 0) goto LAB_0010120d;
  }
  std::operator<<((ostream *)std::cout,&DAT_00102010);
LAB_0010120d:
  (**(code **)*plVar2)(plVar2);
...
void FUN_00101240(void *param_1)
...
// ===== Function: FUN_00101252 =====

void FUN_00101252(void)
