...
// ===== Function: _GLOBAL__sub_I_global_constructor.cpp =====

/* WARNING: Unknown calling convention -- yet parameter storage is locked */

void _GLOBAL__sub_I_global_constructor_cpp(void)
...
{
  std::operator<<((ostream *)PTR_cout_00103fc8,anon_var_dwarf_58);
  std::operator<<((ostream *)PTR_cout_00103fc8,anon_var_dwarf_7b);
  return 0;
}
...

{
  ...
  std::operator<<((ostream *)PTR_cout_00103fc8,anon_var_dwarf_85);
  return;
}
...

{
  ...
  std::operator<<((ostream *)PTR_cout_00103fc8,anon_var_dwarf_9b);
  return;
}
