...

{
  ...
  if (0x10 < (long)uVar10) {
    piVar1 = __first._M_current + 1;
    do {
      bVar14 = __depth_limit == 0;
      ...
      if (bVar14) {
        __make_heap<__gnu_cxx::__normal_iterator<int_*,_std::vector<int,_std::allocator<int>_>_>,___gnu_cxx::__ops::_Iter_less_iter>
                  (__first,__last,&local_31);
        do {
          iVar3 = __last._M_current[-1];
          __last._M_current[-1] = *__first._M_current;
          __last._M_current = __last._M_current + -1;
          uVar10 = (long)__last._M_current - (long)__first._M_current;
          ...
          if (lVar11 < 3) {
            ...
            uVar13 = 0;
            do {
              if (__first._M_current[uVar13 * 2 + 2] < __first._M_current[uVar13 * 2 + 1]) {
                uVar9 = uVar13 * 2 + 1;
              }
              else {
                uVar9 = uVar13 * 2 + 2;
              }
              __first._M_current[uVar13] = __first._M_current[uVar9];
              uVar13 = uVar9;
            } while ((long)uVar9 < (lVar11 - (lVar11 + -1 >> 0x3f)) + -1 >> 1);
          }
          if (((uVar10 & 4) == 0) && (uVar9 == lVar11 + -2 >> 1)) {
            __first._M_current[uVar9] = __first._M_current[uVar9 * 2 + 1];
            uVar9 = uVar9 * 2 + 1;
          }
          if (0 < (long)uVar9) {
            do {
              uVar13 = uVar9 - 1;
              uVar12 = uVar13 >> 1;
              if (iVar3 <= __first._M_current[uVar12]) goto LAB_00101402;
              __first._M_current[uVar9] = __first._M_current[uVar12];
              uVar9 = uVar12;
            } while (1 < uVar13);
            uVar9 = 0;
          }
LAB_00101402:
          __first._M_current[uVar9] = iVar3;
          if ((long)uVar10 < 5) {
            return;
          }
        } while( true );
      ...
      uVar10 = uVar10 >> 1;
      iVar3 = __first._M_current[1];
      iVar4 = __first._M_current[uVar10];
      iVar5 = __last._M_current[-1];
      piVar6 = piVar1;
      _Var8._M_current = __last._M_current;
      if (iVar3 < iVar4) {
        if (iVar4 < iVar5) {
          iVar3 = *__first._M_current;
          *__first._M_current = iVar4;
          __first._M_current[uVar10] = iVar3;
        }
        else {
          iVar4 = *__first._M_current;
          if (iVar3 < iVar5) {
            *__first._M_current = iVar5;
            __last._M_current[-1] = iVar4;
          }
          else {
            *__first._M_current = iVar3;
            __first._M_current[1] = iVar4;
          }
        }
      }
      else if (iVar3 < iVar5) {
      ...
      while( true ) {
        lVar11 = (long)piVar6 + (-4 - (long)__first._M_current);
        do {
          piVar7 = piVar6;
          iVar3 = *piVar7;
          lVar11 = lVar11 + 4;
          piVar6 = piVar7 + 1;
        } while (iVar3 < *__first._M_current);
        do {
          piVar2 = _Var8._M_current + -1;
          _Var8._M_current = _Var8._M_current + -1;
        } while (*__first._M_current < *piVar2);
        if (_Var8._M_current <= piVar7) break;
        *piVar7 = *piVar2;
        *_Var8._M_current = iVar3;
      }
      __introsort_loop<__gnu_cxx::__normal_iterator<int_*,_std::vector<int,_std::allocator<int>_>_>,_long,___gnu_cxx::__ops::_Iter_less_iter>
                (piVar7,__last._M_current,__depth_limit);
      uVar10 = lVar11 >> 2;
      __last._M_current = piVar7;
...

{
  ...
  lVar3 = (long)__last._M_current - (long)__first._M_current >> 2;
  if (1 < lVar3) {
    uVar5 = lVar3 - 2U >> 1;
    uVar4 = lVar3 - 1U >> 1;
    if (((long)__last._M_current - (long)__first._M_current & 4U) == 0) {
      uVar6 = lVar3 - 2U | 1;
      uVar7 = uVar5;
      do {
        iVar1 = __first._M_current[uVar7];
        uVar2 = uVar7;
        while ((long)uVar2 < (long)uVar4) {
          if (__first._M_current[uVar2 * 2 + 2] < __first._M_current[uVar2 * 2 + 1]) {
            uVar8 = uVar2 * 2 + 1;
          }
          else {
            uVar8 = uVar2 * 2 + 2;
          }
          __first._M_current[uVar2] = __first._M_current[uVar8];
          uVar2 = uVar8;
        }
        if (uVar2 == uVar5) {
          __first._M_current[uVar5] = __first._M_current[uVar6];
          uVar2 = uVar6;
        }
        while ((long)uVar7 < (long)uVar2) {
          uVar8 = (long)((uVar2 - ((long)(uVar2 - 1) >> 0x3f)) + -1) >> 1;
          if (iVar1 <= __first._M_current[uVar8]) break;
          __first._M_current[uVar2] = __first._M_current[uVar8];
          uVar2 = uVar8;
        }
        __first._M_current[uVar2] = iVar1;
        bVar9 = uVar7 != 0;
        uVar7 = uVar7 - 1;
      } while (bVar9);
    }
      ...
      do {
        iVar1 = __first._M_current[uVar5];
        uVar7 = uVar5;
        uVar6 = uVar5;
        if ((long)uVar5 < (long)uVar4) {
          do {
            if (__first._M_current[uVar6 * 2 + 2] < __first._M_current[uVar6 * 2 + 1]) {
              uVar7 = uVar6 * 2 + 1;
            }
            else {
              uVar7 = uVar6 * 2 + 2;
            }
            __first._M_current[uVar6] = __first._M_current[uVar7];
            uVar6 = uVar7;
          } while ((long)uVar7 < (long)uVar4);
          while ((long)uVar5 < (long)uVar7) {
            uVar6 = (long)((uVar7 - ((long)(uVar7 - 1) >> 0x3f)) + -1) >> 1;
            if (iVar1 <= __first._M_current[uVar6]) break;
            __first._M_current[uVar7] = __first._M_current[uVar6];
            uVar7 = uVar6;
          }
        }
        __first._M_current[uVar7] = iVar1;
        bVar9 = uVar5 != 0;
        uVar5 = uVar5 - 1;
      } while (bVar9);
    }
