...

{
  ...
  myView.content._M_dataplus._M_p = (pointer)&myView.content.field_2;
  myView.content.field_2._M_allocated_capacity._0_7_ = 0x57206f6c6c6548;
  myView.content.field_2._7_4_ = 0x646c726f;
  myView.content._M_string_length = 0xb;
  myView.content.field_2._M_local_buf[0xb] = '\0';
...

{
  ...
  poVar2 = std::__ostream_insert<char,std::char_traits<char>>
                     ((ostream *)std::cout,(this->content)._M_dataplus._M_p,
  ...
  if (plVar1 != (long *)0x0) {
    ...
    poVar2 = (ostream *)std::ostream::operator<<((ostream *)std::cout,this->accessCount);
