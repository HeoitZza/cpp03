...

{
  ...
  *plVar2 = (long)&PTR__Derived_00103d48;
  lVar3 = __dynamic_cast(plVar2,&Base::typeinfo,&Derived::typeinfo,0);
  if (lVar3 != 0) {
    ...
    if (plVar1 == (long *)0x0) {
      ...
      (*(code *)PTR___libc_start_main_00103fe0)
                (main,unaff_RBX,&stack0xfffffffffffffff0,0,0,extraout_RDX,&stack0xffffffffffffffe8);
      do {
