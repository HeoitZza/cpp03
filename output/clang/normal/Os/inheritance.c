...

{
  ...
  _M_construct<const_char_*>(&local_38,"Red","");
...

{
  ...
  local_38._M_dataplus._M_p = (pointer)&local_38.field_2;
  std::__cxx11::basic_string<char,_std::char_traits<char>,_std::allocator<char>_>::
  _M_construct<char_*>(&local_38,pcVar1,pcVar1 + c->_M_string_length);
  (this->super_Shape)._vptr_Shape = (_func_int **)&PTR_draw_00103da0;
  (this->super_Shape).color._M_dataplus._M_p = (pointer)&(this->super_Shape).color.field_2;
                    /* try { // try from 001012d9 to 001012dd has its CatchHandler @ 0010130c */
  std::__cxx11::basic_string<char,_std::char_traits<char>,_std::allocator<char>_>::
  _M_construct<char_*>
            (&(this->super_Shape).color,local_38._M_dataplus._M_p,
...

{
  ...
  poVar2 = std::__ostream_insert<char,std::char_traits<char>>
                     ((ostream *)puVar1,(this->color)._M_dataplus._M_p,
