...

{
  ...
  plVar2 = (long *)std::ostream::operator<<((ostream *)&std::cout,age);
...

{
  ...
  std::__ostream_insert<char,std::char_traits<char>>((ostream *)&std::cout,&DAT_00102004,8);
  poVar2 = (ostream *)std::ostream::operator<<((ostream *)&std::cout,age);
...

{
  ...
  plVar2 = (long *)std::ostream::operator<<((ostream *)&std::cout,i);
  plVar1 = *(long **)((long)plVar2 + *(long *)(*plVar2 + -0x18) + 0xf0);
  if (plVar1 == (long *)0x0) {
    std::__throw_bad_cast();
  }
...

{
  ...
  if (s == (char *)0x0) {
    std::ios::clear((int)*(undefined8 *)(std::cout + -0x18) + 0x104040);
  }
  else {
    sVar2 = strlen(s);
