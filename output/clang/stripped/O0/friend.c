...
ostream * FUN_00101160(ostream *param_1,int *param_2)
...

{
  ...
  local_c = 0;
  FUN_00101230(local_14,10,0x14);
  poVar1 = std::operator<<((ostream *)PTR_cout_00103fc8,&DAT_0010200b);
  poVar1 = (ostream *)FUN_00101160(poVar1,local_14);
...
void FUN_00101230(undefined4 *param_1,undefined4 param_2,undefined4 param_3)
