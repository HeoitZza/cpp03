...

{
  ...
  pvVar1 = (void *)(*(code *)PTR_operator_new___00103fc8)();
  return pvVar1;
}
...
{
  (*(code *)PTR_operator_delete___00103fd0)();
  return;
}
...

{
  ...
  *plVar1 = 5;
  pSVar3 = (SimpleItem *)(plVar1 + 1);
  for (lVar2 = 4; -1 < lVar2; lVar2 = lVar2 + -1) {
    SimpleItem::SimpleItem(pSVar3);
    pSVar3 = pSVar3 + 1;
  }
  pSVar3 = (SimpleItem *)(plVar1 + 1);
  if (pSVar3 != (SimpleItem *)0x0) {
    this = pSVar3 + *plVar1;
    while (this != pSVar3) {
      this = this + -1;
      SimpleItem::~SimpleItem(this,in_ESI);
    }
...
/* DWARF original prototype: void ~SimpleItem(SimpleItem * this, int __in_chrg) */

void __thiscall SimpleItem::~SimpleItem(SimpleItem *this,int __in_chrg)
