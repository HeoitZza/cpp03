...
/* WARNING: Variable defined which should be unmapped: innerObj */
...
/* DWARF original prototype: void display(Inner * this) */

void __thiscall Outer::Inner::display(Inner *this)
