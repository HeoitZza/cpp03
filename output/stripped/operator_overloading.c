...

{
  ...
  FUN_00101260(local_28,1,2);
  FUN_00101260(local_20,3,4);
  local_18 = FUN_00101288(local_28,local_20);
  poVar1 = std::operator<<((ostream *)std::cout,"Result: ");
  poVar1 = (ostream *)FUN_001012f1(poVar1,&local_18);
...
void FUN_00101260(undefined4 *param_1,undefined4 param_2,undefined4 param_3)
...
// ===== Function: FUN_00101288 =====

undefined8 FUN_00101288(int *param_1,int *param_2)

{
  ...
  local_10 = *(long *)(in_FS_OFFSET + 0x28);
  FUN_00101260(&local_18,*param_1 + *param_2,param_1[1] + param_2[1]);
  if (local_10 != *(long *)(in_FS_OFFSET + 0x28)) {
                    /* WARNING: Subroutine does not return */
    __stack_chk_fail();
  }
...
// ===== Function: FUN_001012f1 =====

ostream * FUN_001012f1(ostream *param_1,int *param_2)
