...

{
  ...
  (*(code *)PTR___libc_start_main_00103fc0)
            (FUN_001011e3,param_2,&stack0x00000008,0,0,param_1,auStack_8);
  do {
...
ostream * FUN_0010117c(ostream *param_1,int *param_2)
...
// ===== Function: FUN_001011e3 =====

undefined8 FUN_001011e3(void)

{
  ...
  std::__ostream_insert<char,std::char_traits<char>>((ostream *)PTR_cout_00103fc8,&DAT_0010200b,0xf)
  ;
  FUN_0010117c(puVar1,&local_18);
