...
/* WARNING: Variable defined which should be unmapped: age_local */
...

{
  ...
  poVar1 = std::operator<<((ostream *)PTR_cout_00103fc8,anon_var_dwarf_23);
...

{
  ...
  poVar1 = std::operator<<((ostream *)PTR_cout_00103fc8,anon_var_dwarf_23);
  poVar1 = (ostream *)std::ostream::operator<<(poVar1,age);
  poVar1 = std::operator<<(poVar1,anon_var_dwarf_46);
...
/* WARNING: Variable defined which should be unmapped: i_local */
...

{
  ...
  poVar1 = std::operator<<((ostream *)PTR_cout_00103fc8,anon_var_dwarf_5c);
...

{
  ...
  poVar1 = std::operator<<((ostream *)PTR_cout_00103fc8,anon_var_dwarf_72);
