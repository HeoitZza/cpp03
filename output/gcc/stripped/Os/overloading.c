...

{
  ...
  poVar1 = (ostream *)(*(code *)PTR__M_insert<double>_00103fc8)();
  return poVar1;
}
...

{
  ...
  FUN_001011e9(0x19);
  FUN_00101216(DAT_00102048,0x19);
  FUN_0010126e(100);
  FUN_0010129b("Hello C++");
  auVar1._8_8_ = 0;
  auVar1._0_8_ = in_RAX;
  return auVar1 << 0x40;
}
...
// ===== Function: FUN_00101216 =====

void FUN_00101216(double param_1,int param_2)

{
  ...
  std::operator<<(poVar1,&DAT_0010200d);
...
void FUN_0010126e(int param_1)

{
  ostream *poVar1;
  
  poVar1 = std::operator<<((ostream *)std::cout,&DAT_00102015);
  poVar1 = (ostream *)std::ostream::operator<<(poVar1,param_1);
  std::endl<char,std::char_traits<char>>(poVar1);
  return;
}
...
// ===== Function: FUN_0010129b =====

void FUN_0010129b(char *param_1)

{
  ostream *poVar1;
  
  poVar1 = std::operator<<((ostream *)std::cout,&DAT_00102025);
