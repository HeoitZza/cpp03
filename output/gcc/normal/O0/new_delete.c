...

{
  ...
  this = (Target *)operator_new(1);
                    /* try { // try from 001011d0 to 001011d4 has its CatchHandler @ 001011f9 */
  Target::Target(this);
  if (this != (Target *)0x0) {
                    /* try { // try from 001011e5 to 001011e9 has its CatchHandler @ 00101218 */
    Target::~Target(this,in_ESI);
...
/* DWARF original prototype: void ~Target(Target * this, int __in_chrg) */

void __thiscall Target::~Target(Target *this,int __in_chrg)
