...

{
  ...
  *plVar2 = (long)&PTR_speak_00103d60;
  __s1 = *(char **)(PTR_typeinfo_00103d58 + 8);
  if (__s1 != "3Dog") {
    if (*__s1 == '*') goto LAB_00101119;
    iVar1 = strcmp(__s1,"3Dog");
    if (iVar1 != 0) goto LAB_00101119;
  }
  std::__ostream_insert<char,std::char_traits<char>>((ostream *)std::cout,&DAT_00102010,0x23);
LAB_00101119:
  (**(code **)*plVar2)(plVar2);
