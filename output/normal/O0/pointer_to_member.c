...

{
  ...
  long in_FS_OFFSET;
  Player p;
  offset_in_Player_to_subr actionPtr;
...
/* DWARF original prototype: void attack(Player * this) */

void __thiscall Player::attack(Player *this)

{
  Player *this_local;
  
  std::operator<<((ostream *)std::cout,"Player Attack!\n");
  return;
}
...
/* DWARF original prototype: void defend(Player * this) */

void __thiscall Player::defend(Player *this)

{
  Player *this_local;
  
  std::operator<<((ostream *)std::cout,"Player Defend!\n");
  return;
}
