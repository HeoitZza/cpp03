...
/* WARNING: Removing unreachable block (ram,0x00101187) */
/* WARNING: Removing unreachable block (ram,0x001011ed) */
...

{
  ...
  local_c = 0;
  local_20 = FUN_00101230;
  local_18 = 0;
  FUN_00101230(&local_21);
  local_20 = FUN_00101260;
  local_18 = 0;
  FUN_00101260(&local_21);
  return 0;
}
...
{
  std::operator<<((ostream *)PTR_cout_00103fc8,"Player Attack!\n");
  return;
}
...
{
  std::operator<<((ostream *)PTR_cout_00103fc8,"Player Defend!\n");
  return;
}
