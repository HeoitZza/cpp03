...
{
  FUN_001012a0(0x19);
  FUN_00101340(DAT_00102048,0x19);
  FUN_00101410(100);
  FUN_001014b0("Hello C++");
  return 0;
}
...
void FUN_00101340(double param_1,int param_2)
...
void FUN_001014b0(char *param_1)
