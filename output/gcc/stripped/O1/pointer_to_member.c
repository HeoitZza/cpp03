...

{
  ...
  (*(code *)PTR___libc_start_main_00103fe0)
            (FUN_00101149,param_2,&stack0x00000008,0,0,param_1,auStack_8);
  do {
...
// ===== Function: FUN_00101149 =====

undefined8 FUN_00101149(void)

{
  std::__ostream_insert<char,std::char_traits<char>>((ostream *)std::cout,"Player Attack!\n",0xf);
  std::__ostream_insert<char,std::char_traits<char>>((ostream *)std::cout,"Player Defend!\n",0xf);
  return 0;
}
