...

{
  ...
  std::__cxx11::string::string(local_78,"Hello World",&local_79);
                    /* try { // try from 00101207 to 00101213 has its CatchHandler @ 00101284 */
  ScrollView::ScrollView((ScrollView *)local_58,(string *)local_78);
                    /* try { // try from 00101219 to 00101221 has its CatchHandler @ 00101270 */
  std::__cxx11::string::~string(local_78);
  std::__new_allocator<char>::~__new_allocator((__new_allocator<char> *)&local_79);
                    /* try { // try from 00101238 to 0010124e has its CatchHandler @ 001012bc */
  ScrollView::display((ScrollView *)local_58);
  ScrollView::display((ScrollView *)local_58);
  myView._36_4_ = 0;
  ScrollView::~ScrollView((ScrollView *)local_58);
  return myView._36_4_;
}
...
/* WARNING: Variable defined which should be unmapped: this_local */
/* DWARF original prototype: void ~ScrollView(ScrollView * this) */

void __thiscall ScrollView::~ScrollView(ScrollView *this)
