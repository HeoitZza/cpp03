...

{
  ...
  (this->super_Animal)._vptr_Animal = (_func_int_varargs **)&PTR__Dog_00103d38;
  iVar3 = Dog::clone(this,in_RSI,__child_stack,in_ECX,in_R8);
  plVar4 = (long *)CONCAT44(extraout_var,iVar3);
  (**(code **)(*plVar4 + 0x18))(plVar4);
  poVar5 = std::operator<<((ostream *)&std::cout,&DAT_0010200c);
  plVar1 = *(long **)(poVar5 + *(long *)(*(long *)poVar5 + -0x18) + 0xf0);
  if (plVar1 == (long *)0x0) {
    auVar6 = std::__throw_bad_cast();
    uVar2 = uStack_28;
    uStack_28 = auVar6._0_8_;
    (*(code *)PTR___libc_start_main_00103fe0)
              (main,uVar2,&stack0xffffffffffffffe0,0,0,auVar6._8_8_,&uStack_28);
    do {
