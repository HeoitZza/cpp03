...

{
  ...
  (*(code *)PTR___libc_start_main_00103fc0)
            (FUN_00101371,param_2,&stack0x00000008,0,0,param_1,auStack_8);
  do {
...
// ===== Function: FUN_001011ac =====

void FUN_001011ac(int param_1)

{
  ...
  plVar1 = (long *)std::ostream::operator<<((ostream *)this,param_1);
...
void FUN_00101208(double param_1,int param_2)

{
  ...
  this = PTR_cout_00103fc8;
  std::__ostream_insert<char,std::char_traits<char>>((ostream *)PTR_cout_00103fc8,&DAT_00102010,8);
  poVar1 = (ostream *)std::ostream::operator<<((ostream *)this,param_2);
  std::__ostream_insert<char,std::char_traits<char>>(poVar1,&DAT_00102019,7);
...
// ===== Function: FUN_0010128d =====

void FUN_0010128d(int param_1)
...
void FUN_001012e9(char *param_1)

{
  ...
  if (param_1 == (char *)0x0) {
    ...
    std::__ostream_insert<char,std::char_traits<char>>((ostream *)PTR_cout_00103fc8,param_1,sVar2);
  }
...
// ===== Function: FUN_00101371 =====

undefined8 FUN_00101371(void)

{
  FUN_001011ac(0x19);
  FUN_00101208(DAT_00102008,0x19);
  FUN_0010128d(100);
  FUN_001012e9("Hello C++");
  return 0;
}
