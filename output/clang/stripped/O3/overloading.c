...

{
  ...
  poVar1 = (ostream *)(*(code *)PTR__M_insert<double>_00104030)();
  return poVar1;
}
...

{
  ...
  (*(code *)PTR___libc_start_main_00103fc0)
            (FUN_00101460,param_2,&stack0x00000008,0,0,param_1,auStack_8);
  do {
...

{
  ...
  std::__ostream_insert<char,std::char_traits<char>>((ostream *)PTR_cout_00103fc8,&DAT_00102010,8);
  plVar2 = (long *)std::ostream::operator<<((ostream *)this,param_1);
...
void FUN_00101250(double param_1,int param_2)

{
  ...
  this = PTR_cout_00103fc8;
  std::__ostream_insert<char,std::char_traits<char>>((ostream *)PTR_cout_00103fc8,&DAT_00102010,8);
  poVar2 = (ostream *)std::ostream::operator<<((ostream *)this,param_2);
  std::__ostream_insert<char,std::char_traits<char>>(poVar2,&DAT_00102019,7);
...

{
  ...
  this = PTR_cout_00103fc8;
  std::__ostream_insert<char,std::char_traits<char>>((ostream *)PTR_cout_00103fc8,&DAT_00102021,0xf)
  ;
  plVar2 = (long *)std::ostream::operator<<((ostream *)this,param_1);
  plVar1 = *(long **)((long)plVar2 + *(long *)(*plVar2 + -0x18) + 0xf0);
  if (plVar1 == (long *)0x0) {
...
void FUN_001013a0(char *param_1)

{
  ...
  std::__ostream_insert<char,std::char_traits<char>>
            ((ostream *)PTR_cout_00103fc8,&DAT_00102031,0x12);
  if (param_1 == (char *)0x0) {
    ...
    std::__ostream_insert<char,std::char_traits<char>>((ostream *)PTR_cout_00103fc8,param_1,sVar3);
  }
...
{
  FUN_001011c0(0x19);
  FUN_00101250(DAT_00102008,0x19);
  FUN_00101310(100);
  FUN_001013a0("Hello C++");
  return 0;
}
