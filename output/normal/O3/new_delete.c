...
{
  std::__ostream_insert<char,std::char_traits<char>>((ostream *)std::cout,&DAT_00102004,0x11);
  std::__ostream_insert<char,std::char_traits<char>>((ostream *)std::cout,&DAT_00102016,0x11);
  return 0;
}
