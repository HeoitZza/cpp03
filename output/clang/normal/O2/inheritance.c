...

{
  ...
  *(undefined1 *)((long)local_58 + local_60) = 0;
  (this->super_Shape)._vptr_Shape = (_func_int **)&PTR_draw_00103da0;
  paVar1 = &(this->super_Shape).color.field_2;
  (this->super_Shape).color._M_dataplus._M_p = (pointer)paVar1;
  __dest = paVar1;
  if (0xf < local_60) {
                    /* try { // try from 00101341 to 00101353 has its CatchHandler @ 001013c9 */
    psVar2 = &(this->super_Shape).color;
    __dest = (anon_union_16_2_edb7204a_for_basic_string<char,_std::char_traits<char>,_std::allocator<char>_>_11
              *)std::__cxx11::string::_M_create((ulong *)psVar2,(ulong)&local_60);
    (psVar2->_M_dataplus)._M_p = (pointer)__dest;
    paVar1->_M_allocated_capacity = local_60;
  }
  if (uVar3 != 0) {
    if (uVar3 == 1) {
      __dest->_M_local_buf[0] = (char)*__src_00;
    }
    else {
      memcpy(__dest,__src_00,uVar3);
    }
  }
