...

{
  ...
  (*(code *)PTR___libc_start_main_00103fc0)
            (FUN_0010116c,param_2,&stack0x00000008,0,0,param_1,auStack_8);
  do {
...

{
  if (DAT_00104018 == '\0') {
    if (PTR___cxa_finalize_00103fb8 != (undefined *)0x0) {
      __cxa_finalize(PTR_LOOP_00104010);
    }
    FUN_00101080();
    DAT_00104018 = 1;
    return;
...
// ===== Function: FUN_0010113c =====

void FUN_0010113c(void)

{
  std::__ostream_insert<char,std::char_traits<char>>
            ((ostream *)PTR_cout_00103fc8,"Graphic draw\n",0xd);
  return;
}



// ===== Function: FUN_00101154 =====

void FUN_00101154(void)

{
  std::__ostream_insert<char,std::char_traits<char>>
            ((ostream *)PTR_cout_00103fc8,"Physics draw\n",0xd);
  return;
}
...

{
  ...
  std::__ostream_insert<char,std::char_traits<char>>
            ((ostream *)PTR_cout_00103fc8,"Graphic draw\n",0xd);
  std::__ostream_insert<char,std::char_traits<char>>((ostream *)puVar1,"Physics draw\n",0xd);
  return 0;
}
