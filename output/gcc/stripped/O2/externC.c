...
void FUN_00101190(int param_1)

{
  ostream *poVar1;
  
  std::__ostream_insert<char,std::char_traits<char>>((ostream *)std::cout,"[C linkage] x=",0xe);
  poVar1 = (ostream *)std::ostream::operator<<((ostream *)std::cout,param_1);
