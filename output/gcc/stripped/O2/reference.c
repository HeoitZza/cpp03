...

{
  ...
  plVar3 = (long *)std::ostream::operator<<((ostream *)std::cout,0xb);
  ...
  if (plVar1 == (long *)0x0) {
    ...
    (*(code *)PTR___libc_start_main_00103fe0)
              (FUN_001010e0,uVar2,&stack0xfffffffffffffff0,0,0,auVar4._8_8_,&uStack_18);
    do {
